...
- **15× MongoDB query speedup** — 1.8s → 120ms at 20K RPS  
- **25× data retrieval improvement** — 5s → 200ms  
- Operated systems handling **50K+ events/sec** with **p95 < 100ms**
...
- High-load backend infrastructure
...
Beyond my work as a backend developer, I mentor junior developers and run meetups for **women in tech in Valencia**.

I also provide my **educational app for learning numbers** to universities and educational institutions **free of charge**.
